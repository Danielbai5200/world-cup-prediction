...
- Scrapes squad rows into `data/processed/transfermarkt_players_latest.csv` and updates the SQLite `players` table team by team when Transfermarkt allows automated access.
...
- API-Football: optional future source for squad and injury data if a paid key is configured.
